  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View className="flex-1 bg-white px-6 pt-6">
        ...
        <Text className="mt-2 text-[15px] text-[#6B7280] font-poppins">Welcome back — pick up where you left off.</Text>

        <View className="items-center mt-6">
          <Image source={images.mascotAuth} style={{ width: 180, height: 160, resizeMode: "contain" }} />
        </View>
        ...
        <View className="mt-6">
          <View className="rounded-[12px] border border-[#EEF0F6] bg-white p-4 shadow-sm mb-4">
            ...
            <TextInput value={email} onChangeText={setEmail} keyboardType="email-address" autoCapitalize="none" placeholder="alex@gmail.com" className="text-base text-[#0D132B]" />
          </View>

          <TouchableOpacity activeOpacity={0.9} onPress={openVerification} className="rounded-[14px] bg-gradient-to-r from-[#5B2BFF] to-[#7C42FF] px-6 py-4 items-center mb-6" style={{ shadowColor: "#7C42FF", shadowOpacity: 0.2, shadowRadius: 10 }}>
          ...
          <View className="items-center">
            <Text className="text-[#6B7280]">Don't have an account? <Text onPress={() => router.replace("/signup")} className="text-[#5B2BFF]">Sign up</Text></Text>
          </View>
        </View>
