    ...
    <SafeAreaView style={styles.appBackground}>
      ...
      >
        ...
        <View style={styles.card}>
          ...
          >
            <Text className="text-[34px] font-bold text-[#0D132B] font-poppins text-left">Sign in</Text>
            <Text className="mt-2 text-[15px] leading-7 text-[#6B7280] font-poppins">Welcome back — pick up where you left off.</Text>
            ...
            <View className="mt-6">
              <View className="rounded-[12px] border border-[#EEF0F6] bg-white p-4 mb-6">
              ...
              <View className="items-center">
                <Text className="text-[#6B7280]">
                  ...
                  <Text onPress={() => router.replace('/signup')} className="text-[#5B2BFF]">Sign up</Text>
                </Text>
              </View>
            </View>
          </ScrollView>
