...
export const LESSONS: Lesson[] = [
...

  {
    ...
    // lesson image — use Unsplash cafe illustration as a suitable visual for the unit
  ...
  // ─── Korean (auto-added) ───────────────────────────────────────────────────
  {
    ...
    icon: "👋",
    xpReward: 10,
    goals: [{ description: "Learn 5 greetings", xpReward: 5 }],
    vocabulary: [
      { word: "안녕하세요", translation: "Hello", pronunciation: "annyeonghaseyo", emoji: "👋" },
      { word: "감사합니다", translation: "Thank you", pronunciation: "gamsahamnida", emoji: "🙏" },
    ],
    phrases: [
      { text: "안녕하세요?", translation: "How are you?", pronunciation: "annyeonghaseyo" },
    ],
    activities: [
      { id: "ko-lesson-1-act-1", type: "multiple-choice", question: 'What does "안녕하세요" mean?', correctAnswer: "Hello", options: ["Hello", "Goodbye", "Thank you"] },
    ],
    aiTeacherPrompt: { systemPrompt: "", introMessage: "", topics: [] },
  ...
  },
  {
    ...
    unitId: "ko-unit-1",
    title: "Self Introduction",
    description: "Say your name and where you're from in Korean",
    icon: "🙋",
    xpReward: 10,
    goals: [{ description: "Introduce yourself", xpReward: 5 }],
    vocabulary: [],
    phrases: [],
    activities: [],
    aiTeacherPrompt: { systemPrompt: "", introMessage: "", topics: [] },
    image: "https://picsum.photos/seed/ko-2/600/400",
  },
  {
    id: "ko-lesson-3",
    unitId: "ko-unit-1",
    title: "Daily Life",
    description: "Common verbs and everyday phrases",
    icon: "🔁",
    xpReward: 10,
    goals: [],
    vocabulary: [],
    ...
    activities: [],
    aiTeacherPrompt: { systemPrompt: "", introMessage: "", topics: [] },
    image: "https://picsum.photos/seed/ko-3/600/400",
  },
  {
    id: "ko-lesson-4",
    unitId: "ko-unit-1",
    ...
    activities: [],
    aiTeacherPrompt: { systemPrompt: "", introMessage: "", topics: [] },
    image: "https://picsum.photos/seed/ko-4/600/400",
  },
  {
    id: "ko-lesson-5",
    unitId: "ko-unit-1",
    title: "Directions & Travel",
    description: "Ask for directions and travel phrases",
    icon: "🧭",
    xpReward: 12,
    goals: [],
    vocabulary: [],
    ...
    activities: [],
    aiTeacherPrompt: { systemPrompt: "", introMessage: "", topics: [] },
    image: "https://picsum.photos/seed/ko-5/600/400",
  },
  ...
  // ─── Chinese (auto-added) ──────────────────────────────────────────────────
  {
    ...
    unitId: "zh-unit-1",
    title: "你好 — Greetings",
    description: "Common Mandarin greetings",
    icon: "👋",
    xpReward: 10,
    goals: [{ description: "Learn common greetings", xpReward: 5 }],
    vocabulary: [
    ...
    activities: [],
    aiTeacherPrompt: { systemPrompt: "", introMessage: "", topics: [] },
    image: "https://picsum.photos/seed/zh-1/600/400",
  },
  {
    id: "zh-lesson-2",
    unitId: "zh-unit-1",
    ...
    activities: [],
    aiTeacherPrompt: { systemPrompt: "", introMessage: "", topics: [] },
    image: "https://picsum.photos/seed/zh-2/600/400",
  },
  {
    id: "zh-lesson-3",
    unitId: "zh-unit-1",
    ...
    activities: [],
    aiTeacherPrompt: { systemPrompt: "", introMessage: "", topics: [] },
    image: "https://picsum.photos/seed/zh-3/600/400",
  },
  {
    id: "zh-lesson-4",
    unitId: "zh-unit-1",
    title: "Food & Drinks",
    description: "Ordering food and drinks in Mandarin",
    icon: "🥡",
    xpReward: 12,
    goals: [],
    vocabulary: [],
    ...
    activities: [],
    aiTeacherPrompt: { systemPrompt: "", introMessage: "", topics: [] },
    image: "https://picsum.photos/seed/zh-4/600/400",
  },
  {
    id: "zh-lesson-5",
    unitId: "zh-unit-1",
    title: "Travel & Directions",
    description: "Useful travel phrases in Mandarin",
    icon: "🧭",
    xpReward: 12,
    goals: [],
    vocabulary: [],
    ...
    activities: [],
    aiTeacherPrompt: { systemPrompt: "", introMessage: "", topics: [] },
    image: "https://picsum.photos/seed/zh-5/600/400",
  },
];
